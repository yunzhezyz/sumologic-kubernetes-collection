{
  ...
  sumologicCollector:: {
    remoteWriteConfigs+: [
      {
        url: "http://$(CHART)-metrics.$(NAMESPACE).svc.cluster.local:9888/prometheus.metrics.state",
        writeRelabelConfigs: [
          {
            action: "keep",
      ...
      {
        url: "http://$(CHART)-metrics.$(NAMESPACE).svc.cluster.local:9888/prometheus.metrics.controller-manager",
        writeRelabelConfigs: [
          {
            action: "keep",
      ...
      {
        url: "http://$(CHART)-metrics.$(NAMESPACE).svc.cluster.local:9888/prometheus.metrics.scheduler",
        writeRelabelConfigs: [
          {
            action: "keep",
      ...
      {
        url: "http://$(CHART)-metrics.$(NAMESPACE).svc.cluster.local:9888/prometheus.metrics.apiserver",
        writeRelabelConfigs: [
          {
            action: "keep",
      ...
      {
        url: "http://$(CHART)-metrics.$(NAMESPACE).svc.cluster.local:9888/prometheus.metrics.kubelet",
        writeRelabelConfigs: [
          {
            action: "keep",
      ...
      {
        url: "http://$(CHART)-metrics.$(NAMESPACE).svc.cluster.local:9888/prometheus.metrics.container",
        writeRelabelConfigs: [
          {
            action: "labelmap",
      ...
      {
        url: "http://$(CHART)-metrics.$(NAMESPACE).svc.cluster.local:9888/prometheus.metrics.node",
        writeRelabelConfigs: [
          {
            action: "keep",
      ...
      {
        url: "http://$(CHART)-metrics.$(NAMESPACE).svc.cluster.local:9888/prometheus.metrics.operator.rule",
        writeRelabelConfigs: [
          {
            action: "keep",
      ...
      {
        url: "http://$(CHART)-metrics.$(NAMESPACE).svc.cluster.local:9888/prometheus.metrics",
        writeRelabelConfigs: [
          {
            action: "keep",
